...
.images__card {
	...
	background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%,
		...
		url('https://img.taste.com.au/Xdxro-U_/w643-h428-cfill-q90/taste/2019/11/gingerbread-cupcakes-taste-1-156163-2.jpg');
...
.images__card:nth-child(2) {
	...
	background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%,
		rgba(17, 17, 17, 0.6) 100%),
		url('https://img.taste.com.au/jh9dzoWB/w643-h428-cfill-q90/taste/2020/03/beehive-cupcakes-159671-2.jpg');
	background-size: 100% 100%;
	background-repeat: no-repeat;
	position: relative;
	color: #fff;
...
.images__card:nth-child(3) {
	...
	background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%,
		rgba(17, 17, 17, 0.6) 100%),
		url('https://img.taste.com.au/vyhsfdni/w643-h428-cfill-q90/taste/2019/02/neapolitan-cupcakes-147102-1.jpg');
	background-size: 100% 100%;
	background-repeat: no-repeat;
	position: relative;
	color: #fff;
...
.images__card:nth-child(4) {
	...
	background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%,
		rgba(17, 17, 17, 0.6) 100%),
		url('https://img.taste.com.au/5tq_4AaL/w643-h428-cfill-q90/taste/2019/08/unicorn-cupcakes-taste-153258-1.jpg');
	background-size: 100% 100%;
	background-repeat: no-repeat;
	position: relative;
	color: #fff;
...
.images__card:nth-child(6) {
	...
	background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%,
		rgba(17, 17, 17, 0.6) 100%),
		url('https://img.taste.com.au/fj9eabhB/w643-h428-cfill-q90/taste/2016/11/lamington-cupcakes-49475-1.jpeg');
	background-size: 100% 100%;
	background-repeat: no-repeat;
	position: relative;
	color: #fff;
